...
#+begin_src python
  ...
  outfile = f"muse-hr-data-ha-raman-TOTAL-SHORT{suffix}.fits"
  fits.PrimaryHDU(
      data=data,
      header=hdus["R040"].header,
  ).writeto(
...
#+begin_src python :return figfile :results file
  ...
  hdu = fits.open(f"{datapath}/muse-hr-data-ha-raman-TOTAL-multibin-2000.fits")["SCALED"]
  w = WCS(hdu.header)
  ...
  fig, ax = plt.subplots(figsize=(6.2, 5), subplot_kw=dict(projection=w))
  ax.imshow(hdu.data, vmin=700, vmax=5000, origin="lower", cmap="viridis")
