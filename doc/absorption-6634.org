...
***** Herschel line maps
#+call: bar-profile(INFILE="herschel-bar-oi-63mic-line.fits", HDU=0, NBLOCK=16)

#+RESULTS:
[[file:herschel-bar-oi-63mic-line-bar-profile.jpg]]

#+call: bar-profile(INFILE="herschel-bar-oi-63mic-cont.fits", HDU=0, NBLOCK=16)
...
#+call: bar-profile(INFILE="herschel-bar-oi-146mic-line.fits", HDU=0, NBLOCK=32)

#+RESULTS:
[[file:herschel-bar-oi-146mic-line-bar-profile.jpg]]

#+call: bar-profile(INFILE="herschel-bar-oi-146mic-cont.fits", HDU=0, NBLOCK=32)

#+RESULTS:
[[file:herschel-bar-oi-146mic-cont-bar-profile.jpg]]

#+call: bar-profile(INFILE="herschel-bar-co-145mic-line.fits", HDU=0, NBLOCK=32)

#+RESULTS:
[[file:herschel-bar-co-145mic-line-bar-profile.jpg]]

#+call: bar-profile(INFILE="herschel-bar-nii-122mic-line.fits", HDU=0, NBLOCK=64)
