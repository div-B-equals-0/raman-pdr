...
#+begin_src python :results file :return figfile
  ...
  for skyregion in regions:
      ...
      pixelregion.plot(ax=ax, color="w")
...
#+name: rgb-limits-co-irac1-radio
| orion-13co.fits     | 0 |   30 |
| orion-irac-1.fits   | 0 | 1000 |
| radiotau-radec.fits | 0 |  1.2 |

#+call: rgb-lupton-regions(TAB=rgb-limits-co-irac1-radio, SUFFIX="co-irac1-radio", HDU=0, STRETCH=0.5, Q=8)

#+RESULTS:
[[file:rgb-lupton-regions-co-irac1-radio.jpg]]
