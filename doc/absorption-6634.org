...
+ Raman wing brightness units
  ...
  + So each pixel is 3.08641975309e-9 sr, so units are 3.24e-12 erg s^{-1} cm^{-2} \AA^{-1}
...
#+begin_src python :return figfile :results file
  ...
  for blue, red, alpha, cb, cr, wav in raman_bands:
      ...
      # Put in units of 1e-10 erg/s/cm2/sr/AA
      yb /= 324
      yr /= 324
...
+ There are several reasons for these models:
  ...
  2. Predict the O I flourescent line emissivity
