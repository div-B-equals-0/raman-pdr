...
#+begin_src python
  ...
  hdus = {}
  for band in bands:
      infile = f"muse-hr-data-ha-raman-{band}-cont-sub-multibin.fits"
      hdus[band] = fits.open(f"{datadir}/{infile}")[0]


  data = np.sum([hdus[band].data for band in bands], axis=0)
  outfile = "muse-hr-data-ha-raman-TOTAL-multibin.fits"
  fits.PrimaryHDU(
      data=data,
  ...
  data = np.sum([hdus[band].data for band in ["R040", "R057", "B033", "B054"]], axis=0)
  outfile = "muse-hr-data-ha-raman-TOTAL-SHORT-multibin.fits"
  fits.PrimaryHDU(
      data=data,
      header=hdus["R040"].header,
  ).writeto(
  ...
  outfile = "muse-hr-data-ha-raman-RED-BLUE-multibin.fits"
  fits.PrimaryHDU(
      data=data,
      header=hdus["R040"].header,
  ).writeto(
  ...
  outfile = "muse-hr-data-ha-raman-FAR-NEAR-multibin.fits"
  fits.PrimaryHDU(
      data=data,
      header=hdus["R040"].header,
  ).writeto(
...
python src/raman-multibin-combine.py data/orion-muse/muse-hr-data-ha-raman-R040-cont-sub 2000 0.0
#+end_src

#+begin_src sh :results silent :dir ..
python src/raman-multibin-combine.py data/orion-muse/muse-hr-data-ha-raman-R057-cont-sub 2000 0.0
#+end_src

#+begin_src sh :results silent :dir ..
python src/raman-multibin-combine.py data/orion-muse/muse-hr-data-ha-raman-R087-cont-sub 2000 0.0
#+end_src

#+begin_src sh :results silent :dir ..
python src/raman-multibin-combine.py data/orion-muse/muse-hr-data-ha-raman-R136-cont-sub 2000 0.0
#+end_src

#+begin_src sh :results silent :dir ..
python src/raman-multibin-combine.py data/orion-muse/muse-hr-data-ha-raman-B033-cont-sub 2000 0.0
#+end_src

#+begin_src sh :results silent :dir ..
python src/raman-multibin-combine.py data/orion-muse/muse-hr-data-ha-raman-B054-cont-sub 2000 0.0
#+end_src

#+begin_src sh :results silent :dir ..
python src/raman-multibin-combine.py data/orion-muse/muse-hr-data-ha-raman-B080-cont-sub 2000 0.0
#+end_src
...
| muse-hr-data-ha-raman-R087-cont-sub-multibin-2000.fits | 35 |  550 |
| muse-hr-data-ha-raman-R057-cont-sub-multibin-2000.fits | 35 | 1200 |
| muse-hr-data-ha-raman-R040-cont-sub-multibin-2000.fits | 35 | 1600 |
...
| muse-hr-data-ha-raman-B080-cont-sub-multibin-2000.fits | 25 |  300 |
| muse-hr-data-ha-raman-B054-cont-sub-multibin-2000.fits | 30 | 1000 |
| muse-hr-data-ha-raman-B033-cont-sub-multibin-2000.fits | 30 | 2000 |
