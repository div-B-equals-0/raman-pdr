...
\begin{figure}
  ...
  \caption{Optical depth of select processes as a function of total
    ...
    are situated to the left in this figure.  The two panels show two
    models that differ only in the assumed dust opacity: low opacity
    (\(\sigma\FUV \approx \SI{2e-22}{cm^2.H^{-1}}\)) in the upper panel and high
    opacity (\(\sigma\FUV \approx \SI{5e-22}{cm^2.H^{-1}}\)) in the lower panel.}
...
\begin{figure}
  ...
  \caption{(a) Predicted spectrum of Trapezium stars in vicinity of
    ...
    \(\lambda_1\), which is slightly non-linear in \(\Delta\lambda_2\).  }
