...
\begin{figure*}
  ...
  \caption{MUSE spectra of the Orion Nebula centered on the
    ...
    to the continuum at \SI{6200}{\AA} and are offset vertically as
...
expected to be smooth on a \SI{100}{\angstrom} scale, but nonetheless
the systematic uncertainties in the continuum interpolation is an
...
emission (see below), which makes the identification uncertain.
...
Rayleigh/Raman scattering cross section in each band is also given in
the table, varying between about \SI{1e-22}{cm^2} and
\SI{2e-21}{cm^2}.
...
\SI{6280}{\angstrom}, which is clearly seen in all the spectra but
lies well away from the Raman wings.  The blue Raman wing is affected
by weaker \chem{H_2 O} bands at \SIrange{6460}{6600}{\angstrom}.  In
summary, the nebular and telluric contamination introduces
