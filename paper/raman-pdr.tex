...
expected to be smooth on a \SI{100}{\angstrom} scale,\footnote{The
  ...
  \(\pm \SI{20}{\AA}\) of the rest wavelength and so does not affect
...
blue wing shows some other weak features that remain unidentified, the
strongest of which is an apparent broad
(\(\approx \SI{5}{\angstrom}\)) absorption feature at \SI{6495}{\AA}.
