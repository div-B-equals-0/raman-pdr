...
not only by dust extinction, but also the opacity of the Rayleigh/Raman scattering itself.
...
it is necessary to look at the spatial distribution of the Raman-scattered intensity.
...
If \(\tau_1\) is dominated by the \lyb{} wing opacity 
and the total column density of \chem{H^0} is sufficiently large,
