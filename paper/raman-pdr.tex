...
{\ifnum#2=1\setbox0=\hbox{\def\label##1{\gdef\templabel{##1}}#7}\fi
  ...
  %%% WJH 13 Oct 2019 - comment out this penalty because it causes
  %%% page breaks after section titles
...
\subsubsection{Lines from ionized gas and the ionization front}
...
\subsubsection{Spatial profiles of the Raman bands}
...
\subsubsection{Other PDR tracers}
