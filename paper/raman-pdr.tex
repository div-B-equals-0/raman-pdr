...
\begin{figure}
  ...
  \caption{
    Correlation between observed equivalent width,
    \(W_\lambda(5780)\),
    of Diffuse Interstellar Band and reddening, \(E(B - V)\).
    False-color image shows histogram of pixels across the face of the nebula,
    calculated from the MUSE spectral cube
    (panel c and f from Fig.~\ref{fig:raman-multi-absorption-features},
    assuming \(E(B - V) = 0.3845 C(\hb)\)).
    Straight lines shows fits to surveys of DIBs along sight lines
    to \(\sigma\)-type stars (dotted line, \citealp{Kos:2013a})
    and galaxies (dashed line, \citealp{Baron:2015a}).
...
at \SI{5780}{\AA}, which is shown in Figure~\ref{fig:raman-multi-absorption-features}c.
