...
\(W_\lambda^{\text{Raman}}(6633) = \SI{2.2 \pm 1.0}{\AA}\)
...
\begin{enumerate}[1.]
\item Hydrogen Raman scattering occurs in the neutral photo-dissociation region (PDR),
...
\item Far-ultraviolet resonance lines of neutral oxygen imprint their absorption
  ...
  The subsequent Raman scattering of this continuum yields absorption features
  in the red \ha{} wing
  at transformed wavelengths of \SI{6633}{\angstrom} and \SI{6664}{\angstrom}.
\item The ``magnification'' of Doppler velocity scales by the Raman scattering process
