...
\begin{table*}
  \caption{Fit parameters from Gaussian line fits to Keck HIRES spectra in Orion South}
  \label{tab:line-fits}
  \begin{tabular}{l RRR @{\hspace*{1cm}} RRR}\toprule
     & \multicolumn{3}{c}{\ion{O}{1} Raman absorption \SI{6663.75}{\angstrom}} & \multicolumn{3}{c}{[\ion{Ni}{2}] emission \SI{6666.80}{\angstrom}} \\
    Region & A & V, \si{km.s^{-1}} & W, \si{km.s^{-1}} & A & V, \si{km.s^{-1}} & W, \si{km.s^{-1}} \\
    (1) & (2) & (3) & (4) & (5) & (6) & (7) \\
    \midrule
    A & 0.050 \pm 0.003 & 0.3 \pm 0.4 & 14.5 \pm 0.9 & 0.75 \pm 0.02 & 0.4 \pm 0.1 & 9.7 \pm 0.3\\
    B & 0.039 \pm 0.004 & -1.6 \pm 0.5 & 9.6 \pm 1.1 & 0.71 \pm 0.02 & 2.7 \pm 0.1 & 9.9 \pm 0.3\\
    C & 0.030 \pm 0.005 & -1.2 \pm 0.6 & 7.6 \pm 1.5 & 0.60 \pm 0.02 & 2.9 \pm 0.2 & 10.5 \pm 0.4\\
    D & 0.022 \pm 0.007 & 1.3 \pm 1.0 & 7.2 \pm 2.4 & 0.46 \pm 0.01 & 1.8 \pm 0.2 & 10.4 \pm 0.4\\
    E &  &  &  & 0.29 \pm 0.01 & 3.6 \pm 0.2 & 9.1 \pm 0.5\\
    \bottomrule 
    \multicolumn{7}{@{}p{12cm}@{}}{%
    \textsc{Columns}:
    (1)~Region of nebula covered by HIRES slits (see Figure~\ref{fig:zoom-keck}).
    (2, 3, 4)~Parameters of gaussian fit to \ion{O}{1} Raman-scattered absorption line:
    peak absorption depth relative to continuum, \(A\),
    centroid velocity, \(V\), and FWHM line width, \(W\).
    For \(V\) and \(W\), the apparent values have been divided by \num{6.3999329}
    to account for the stretching of the Doppler scale between the UV and optical frames.
    (5, 6, 7)~Parameters of gaussian fit to [\ion{Ni}{2}] emission line.
    }
  \end{tabular}
\end{table*}
