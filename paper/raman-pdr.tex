...
across most of the nebula, but with much larger values to the SE,
with a pronounced peak of \(W_\lambda\observed (4686) \approx \SI{0.5}{\angstrom}\)
around the star \th2A.\@
In contrast, the \ion{C}{4} lines show a broad maximum of 
\(W_\lambda\observed (5801 + 5812) = \SI{0.12 \pm 0.04}{\angstrom}\),
...
The most straightforward to interpret is \ion{C}{4},
since the 5801,5812 doublet is present in the spectrum of \th1C
with an equivalent width \(W_\lambda\star = \SI{0.30}{\angstrom}\),
...
and the starlight from the lower mass members of the Trapezium
