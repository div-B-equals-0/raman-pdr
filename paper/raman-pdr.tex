...
\begin{table*}
  ...
  \begin{tabular}{r r R R R R c }\toprule
    ...
    & [\ion{O}{2}] \(\lambda 7318\) & -9.4 \pm 3.6& 25 & 0.882 & 0.232 \pm 0.026 & \\    
    & [\ion{O}{1}] \(\lambda 6300\) & -1.7 \pm 0.1& 9 & 0.152 & 0.045 \pm 0.001 & \\     
    & \ion{O}{1}   \(\lambda 8446\) & 0.0 \pm 0.8& 8 & 0.226 & 0.071 \pm 0.000 & \\      
    ...
    & \chem{H_2} \SI{2.21}{\micron} & 23.6 \pm 0.1 & 19 & 0.169 & 0.997 \pm 0.002 & 5 \\
    ...
    & [\ion{C}{1}] \(\lambda 8727\) & 37.7 \pm 5.9 & 30 & 0.495 & 0.854 \pm 0.122 & 1 \\
    ...
    Columns: (1)~Type of tracer and surface brightness units for the values
    given in columns~5 and~6.
    (2)~Specific emission line or continuum band.
    (3)~Position of fitted Gaussian relative to ionization front.
    The uncertainty is given as the difference between the fitted Gaussian peak
    and the actual data peak.
    (4)~FWHM of fitted Gaussian. Note that this is not corrected for
    the instrumental PSF, which is substantial in the case of the Herschel and CARMA
    data but negligible in most other cases.
    ...
    6.~Herschel--PACS \citet{Parikka:2018a};
    7.~Carma--NRO \citet{Kong:2018a}.
    }
  \end{tabular}
\end{table*}
