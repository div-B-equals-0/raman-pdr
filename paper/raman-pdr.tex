...
The line widths are of order \SI{8}{km.s^{-1}} for [\ion{Ni}{2}],
which is overwhelmingly non-thermal
since the thermal broadening is only \SI{3}{km.s^{-1}} for \(T = \SI{e4}{K}\).
This is similar to the width of other collisional lines (e.g., [\ion{O}{1}])
and fluorescent lines (e.g., [\ion{N}{1}]) that form near the ionization front
\citetext{see Table~12 of \citealp{Ferland:2012a}}.
