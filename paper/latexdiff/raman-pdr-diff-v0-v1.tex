...
%DIF DEL raman-pdr-v0-expand.tex   Sat Jan 23 22:56:29 2021
%DIF ADD raman-pdr-v1-expand.tex   Sat Jan 23 22:59:21 2021
...
domain.
\DIFaddbegin \DIFadd{Further astrophysical applications have included planetary nebulae
\mbox{%DIFAUXCMD
\citep{Pequignot:1997a, Arrieta:2003a, Lee:2006a}
}\hspace{0pt}%DIFAUXCMD
and active galactic nuclei \mbox{%DIFAUXCMD
\citep{Chang:2015a}}\hspace{0pt}%DIFAUXCMD
.
}\DIFaddend 
...
photoionization cross section at \DIFdelbegin \DIFdel{threshold }\DIFdelend \DIFaddbegin \DIFadd{the Lyman limit }\DIFaddend \citep{Osterbrock:2006a}.
...
\begin{figure}
  \centering
%DIF >   \includegraphics[width=\linewidth]{figs/raman-fov-regions-lores}
% inside_import 
% before   
% ignored  
% args width=\linewidth
%DIF <  full_filename figs/raman-fov-regions-lores
%DIF >  full_filename figs/raman-fov-regions
% after 
  \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\linewidth]{figs/raman-fov-regions-lores}
%DIFDELCMD <   %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\linewidth]{figs/raman-fov-regions}
  \DIFaddendFL \caption{(a)~Panoramic view of the Orion Nebula region on parsec
...
% ignored  
% args width=\linewidth
%DIF <  full_filename figs/raman-orion-muse-1d-spectra
%DIF >  full_filename figs/raman-orion-muse-1d-spectra-wavsec23
% after 
  \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\linewidth]{figs/raman-orion-muse-1d-spectra}
%DIFDELCMD <   %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\linewidth]{figs/raman-orion-muse-1d-spectra-wavsec23}
  \DIFaddendFL \caption{MUSE spectra of the Orion Nebula centered on the
    ...
    together with \DIFdelbeginFL \DIFdelFL{unidentified
    }\DIFdelendFL candidate \DIFaddbeginFL \DIFaddFL{DIB and unidentified
    }\DIFaddendFL absorption features marked with ``?''.  Dotted lines
...
\DIFaddbegin \DIFadd{Two additional extraction regions (dotted boxes in the figure) are chosen
to cover the blueshifted high-ionization ``Big Arc'' feature
\mbox{%DIFAUXCMD
\citep{Doi:2004a}}\hspace{0pt}%DIFAUXCMD
,
where the extended wings are relatively weak,
and the highly extinguished ``Dark Bay'' to the NE of the nebula.
}\DIFaddend The continuum is interpolated under the wings by fitting a
...
continuum is \DIFaddbegin \DIFadd{mostly }\DIFaddend a combination of Paschen recombination emission from
...
expected to be smooth on a \SI{100}{\angstrom} scale,%DIF > 
\footnote{\DIFdelbegin \DIFdel{The
  only }\DIFdelend \DIFaddbegin \DIFadd{One }\DIFaddend exception is the dust-scattered \ha{} line from the stellar
...
\DIFaddbegin \DIFadd{Another potential contribution to the continuum comes from 
Extended Red Emission \mbox{%DIFAUXCMD
\citetext{ERE; \citealp{Schmidt:1980a}}}\hspace{0pt}%DIFAUXCMD
,
which is likely to be the result of complex fluorescent processes in small carbon-based molecules
\mbox{%DIFAUXCMD
\citep{Witt:2020a} }\hspace{0pt}%DIFAUXCMD
that are located in the neutral hydrogen region
\mbox{%DIFAUXCMD
\citep{Lai:2017a}}\hspace{0pt}%DIFAUXCMD
.
A broad bump (\(\text{FWHM} \approx \SI{1800}{\angstrom}\)) centered on \(\approx \SI{8200}{\angstrom}\)
is reported in the spectrum of sections of the Orion Bar by \mbox{%DIFAUXCMD
\citet{Perrin:1992a}}\hspace{0pt}%DIFAUXCMD
.
...
\DIFaddend \subsection{Raman scattered FUV absorption lines}
...
Raman wings show some other weak features \DIFdelbegin \DIFdel{that remain unidentified}\DIFdelend \DIFaddbegin \DIFadd{of uncertain origin}\DIFaddend ,
the strongest of which is an apparent broad
(\(\approx \SI{5}{\angstrom}\)) absorption feature at \SI{6494}{\angstrom},
while additional narrower features are seen at \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\SI{6450}{\angstrom}
}\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\num{6439},
\num{6449} }\DIFaddend and \SI{6708}{\angstrom}
(all marked \DIFdelbegin \DIFdel{with ``?'' }\DIFdelend in Figure~\ref{fig:raman-spectra-1d}).
It is \DIFdelbegin \DIFdel{not clear if these are
truly absorption features or whether they are simply gaps between very
weakblended emission lines}\DIFdelend \DIFaddbegin \DIFadd{likely that at least some of these features may be
...
and \mbox{%DIFAUXCMD
\SI{6614}{\angstrom} }\hspace{0pt}%DIFAUXCMD
(weak)}\DIFaddend .
...
\DIFaddbegin \footnote{
  \DIFadd{The }[\ion{O}{1}] \DIFadd{line is contaminated by airglow emission from the Earth's upper atmosphere,
  ...
  a comparison with space-based }\textit{\DIFadd{HST}} \DIFadd{observations
  \mbox{%DIFAUXCMD
\citep{ODell:1997a} }\hspace{0pt}%DIFAUXCMD
shows a good agreement.
}}

\DIFaddend In red is shown the fluorescent \ion{O}{1}
\SI{8446.36}{\angstrom} line, which traces fully neutral gas that is
very close behind the ionization front.  This image clearly
illustrates that the neutral/molecular gas is organized in \DIFdelbegin \DIFdel{filaments}\DIFdelend \DIFaddbegin \DIFadd{linear features}\DIFaddend ,
...
\DIFdelbegin \DIFdel{filaments }\DIFdelend \DIFaddbegin \DIFadd{features }\DIFaddend are seen in all directions from the Trapezium (see also
Figure~\ref{fig:raman-fov-regions}b).
\DIFaddbegin \DIFadd{Although the true three-dimensional shape of these bars has not been
...
}\DIFaddend A particularly complex region,
...
%DIF >  before   
%DIF >  ignored  
%DIF >  args width=\linewidth
%DIF >  full_filename figs/dib-orion-muse-1d-spectra
%DIF >  after 
  \includegraphics[width=\linewidth]{figs/dib-orion-muse-1d-spectra}
  \caption{
    \DIFaddFL{MUSE spectra of the Orion Nebula showing absorption features
    ...
    All spectra are normalized to the flux at \mbox{%DIFAUXCMD
\SI{5840}{\angstrom}}\hspace{0pt}%DIFAUXCMD
,
...
\DIFaddend \subsection{Equivalent widths of absorption features}
...
\DIFaddbegin \DIFadd{Sample spectra that illustrate some of these absorption features
...
The results in Figure\DIFaddbegin \DIFadd{~}\DIFaddend \ref{fig:raman-multi-absorption-features}d
...
\DIFaddbegin \DIFadd{Representative spectra that include the }\ion{C}{4} \DIFadd{doublet
are shown in Figure~\ref{fig:dib-spectra}. 
}\DIFaddend Neither of these lines are expected to be seen in emission
...
However, it has been suggested \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citep{Smith:2005a} }\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep{ODell:1993b, ODell:2001b, Smith:2005a} }\hspace{0pt}%DIFAUXCMD
}\DIFaddend that \th1D may lie
...
\DIFaddbegin \DIFadd{Another stellar absorption line that is visible in the spectra
is }\ion{N}{3} \DIFadd{\mbox{%DIFAUXCMD
\SI{5896.1}{\angstrom}}\hspace{0pt}%DIFAUXCMD
,
which shows a deeper absorption
than the }\ion{C}{4} \DIFadd{doublet in some parts of the nebula,
see Figure~\ref{fig:dib-spectra}.
However, its blue flank is badly contaminated by the
}\ion{Na}{1} \DIFadd{\mbox{%DIFAUXCMD
\SI{5895.923}{\angstrom} }\hspace{0pt}%DIFAUXCMD
airglow line
\mbox{%DIFAUXCMD
\citetext{see Fig.~5 of \citealp{Osterbrock:1996a}}}\hspace{0pt}%DIFAUXCMD
,
...
\subsubsection{\DIFdelbegin \DIFdel{Solid-state absorption features}\DIFdelend \DIFaddbegin \DIFadd{Diffuse interstellar bands}\DIFaddend }
...
DIB absorption and the continuum dust \DIFdelbegin \DIFdel{absorption }\DIFdelend \DIFaddbegin \DIFadd{extinction }\DIFaddend are very similar.
...
\DIFaddbegin \DIFadd{It can also be seen in the sample spectra shown in Figure~\ref{fig:dib-spectra}:
the deepest DIB absorption is seen for the Dark Bay sample,
a high-extinction region in the North East of the nebula. 
}\DIFaddend This is tested quantitatively in Figure~\ref{fig:dib-redden},
...
Orion Nebula sight lines is characteristic of \(\sigma\)-type \DIFdelbegin \DIFdel{DIBS
}\DIFdelend \DIFaddbegin \DIFadd{DIBs
}\DIFaddend (after the prototype \(\sigma\)~Sco; \citealp{Krelowski:1988a}),
...
\DIFdelbegin \DIFdel{A further DIB feature is }\DIFdelend \DIFaddbegin \DIFadd{Additional DIB features are }\DIFaddend seen in the \DIFdelbegin \DIFdel{spectra at \mbox{%DIFAUXCMD
\SI{6284}{\angstrom}}\hspace{0pt}%DIFAUXCMD
.
However,
it is hard to estimate the equivalent width
of this feature
}\DIFdelend \DIFaddbegin \DIFadd{spectral region of the }\ha{} \DIFadd{Raman wings
(see Figure~\ref{fig:raman-spectra-1d} and section~\ref{sec:raman-scattered-fuv}).
The strongest of these is the \mbox{%DIFAUXCMD
\SI{6284}{\angstrom} }\hspace{0pt}%DIFAUXCMD
feature,
but it is difficult to estimate its equivalent width
}\DIFaddend since it overlaps with telluric \chem{O_2} \(\gamma\)-band absorption\DIFdelbegin \DIFdel{(see Figure~\ref{fig:raman-spectra-1d}).
}\DIFdelend \DIFaddbegin \DIFadd{.
The \mbox{%DIFAUXCMD
\SI{6614}{\angstrom} }\hspace{0pt}%DIFAUXCMD
feature \mbox{%DIFAUXCMD
\citep{Bernstein:2018a} }\hspace{0pt}%DIFAUXCMD
is much weaker,
and is only convincingly detected in the Dark Bay sample.
Several other absorption features in the range \num{6400} to \mbox{%DIFAUXCMD
\SI{6500}{\angstrom}
}\hspace{0pt}%DIFAUXCMD
show correlation with dust extinction and coincide in
wavelength with DIB features reported in \mbox{%DIFAUXCMD
\citet{Galazutdinov:2000a}}\hspace{0pt}%DIFAUXCMD
. 
}\DIFaddend 
...
% ignored  
% args width=\linewidth
%DIF <  full_filename figs/raman-zoom-keck-regions-lores
%DIF >  full_filename figs/raman-zoom-keck-regions
% after 
  \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\linewidth]{figs/raman-zoom-keck-regions-lores}
%DIFDELCMD <   %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\linewidth]{figs/raman-zoom-keck-regions}
  \DIFaddendFL \caption{Zoom on Trapezium and Orion South region, showing the locations
...
\begin{table}
  ...
  \begin{tabular*}{\columnwidth}{@{\extracolsep{\fill}} l  RRR}\toprule
    ...
    A &  0.75 \pm 0.02 & \DIFdelbeginFL \DIFdelFL{0.4 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{1.5 }\DIFaddendFL \pm 0.1 & 7.7 \pm 0.4\\
    B &  0.71 \pm 0.02 & \DIFdelbeginFL \DIFdelFL{2.7 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{3.7 }\DIFaddendFL \pm 0.1 & 7.9 \pm 0.4\\
    C &  0.60 \pm 0.02 & \DIFdelbeginFL \DIFdelFL{2.9 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{4.0 }\DIFaddendFL \pm 0.2 & 8.6 \pm 0.5\\
    D & 0.46 \pm 0.01 & \DIFdelbeginFL \DIFdelFL{1.8 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{2.8 }\DIFaddendFL \pm 0.2 & 8.5 \pm 0.4\\
    E & 0.29 \pm 0.01 & \DIFdelbeginFL \DIFdelFL{3.6 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{4.6 }\DIFaddendFL \pm 0.2 & 6.8 \pm 0.6\\
    \addlinespace[\medskipamount]
    & \multicolumn{3}{c}{\ion{O}{1} Raman-scattered absorption \SI{6663.75}{\angstrom}} \\[2pt]
    A & 0.050 \pm 0.003 & \DIFdelbeginFL \DIFdelFL{0.3 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{0.4 }\DIFaddendFL \pm 0.4 & 14.5 \pm 1.0  \\
    B & 0.039 \pm 0.004 & \DIFdelbeginFL \DIFdelFL{-1.6 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{-1.4 }\DIFaddendFL \pm 0.5 & 9.6 \pm 1.1  \\
    C & 0.030 \pm 0.005 & \DIFdelbeginFL \DIFdelFL{-1.2 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{-1.0 }\DIFaddendFL \pm 0.6 & 7.6 \pm 1.5  \\
    D & 0.022 \pm 0.007 & \DIFdelbeginFL \DIFdelFL{1.3 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{1.5 }\DIFaddendFL \pm 1.0 & 7.2 \pm 2.5    \\
    \bottomrule 
...
\(V_{\mathrm{LSR}} = \SI{+9.0 \pm 0.2}{km.s^{-1}}\) or \DIFdelbegin \DIFdel{\(V_{\odot} = \SI{+28.1 \pm 0.2}{km.s^{-1}}\)}\DIFdelend \DIFaddbegin \DIFadd{\(V_{\odot} = \SI{+27.1 \pm 0.2}{km.s^{-1}}\)}\DIFaddend .
...
\citetext{e.g., Fig.~14 of \citealp{Baldwin:2000a}}.\footnote{
  ...
  seems to show a consistent redshift of order \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\SI{2}{km.s^{-1}} }\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\SI{3}{km.s^{-1}} }\hspace{0pt}%DIFAUXCMD
}\DIFaddend with respect to CO,
  this is \DIFdelbegin \DIFdel{probably not }\DIFdelend \DIFaddbegin \DIFadd{only marginally }\DIFaddend significant given that the rest wavelength accuracy of \SI{0.03}{\angstrom}
...
\citet{Luhman:1998a} find densities of \SI{e5}{cm^{-3}} to \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\SI{e6}{cm^-3}}\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\SI{e6}{cm^{-3}}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend ,
...
the \lyb{} wing cross-section falls below the dust \DIFdelbegin \DIFdel{extinction }\DIFdelend \DIFaddbegin \DIFadd{absorption }\DIFaddend cross-section,
...
\DIFdelbegin \DIFdel{within the range }\DIFdelend \DIFaddbegin \DIFadd{slightly lower than }\DIFaddend predicted for dense clouds \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citep{Cardelli:1989a}}\hspace{0pt}%DIFAUXCMD
,although }\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep{Cardelli:1989a, Weingartner:2001a}}\hspace{0pt}%DIFAUXCMD
,%DIF > 
}\footnote{
  \DIFadd{For instance, from the modelled extinction cross sections and albedos
  of dust with total to selective ratios \(R_V = 4.5\) to \(5.5\)
  \mbox{%DIFAUXCMD
\citetext{Figs.~14 amd 15 of \citealp{Weingartner:2001a}}}\hspace{0pt}%DIFAUXCMD
,
  the }\emph{\DIFadd{absorption}} \DIFadd{cross section at }\lyb{} \DIFadd{is predicted to be
  \num{6.5e-22} to \mbox{%DIFAUXCMD
\SI{1.05e-21}{cm^{2}}}\hspace{0pt}%DIFAUXCMD
.
}}
\DIFadd{suggesting that some dust destruction may have occurred in the Orion Bar.
Note that }\DIFaddend \citet{Salgado:2016a} find that \DIFdelbegin \DIFdel{a }\DIFdelend \DIFaddbegin \DIFadd{an even }\DIFaddend lower value of
...
\paragraph*{Why they cannot be \DIFdelbegin \DIFdel{solid-state absorption }\DIFdelend \DIFaddbegin \DIFadd{Diffuse Interstellar Band }\DIFaddend features}
...
\SI{5e22}{cm^{2}.H^{-1}}}\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\SI{5e-22}{cm^{2}.H^{-1}}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend .
\item Far-ultraviolet resonance lines of neutral oxygen imprint their absorption
  ...
  such as electron scattering or high-velocity outflows.
\item
  The widths of the Raman-scattered absorption lines are of order \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\SI{2}{\AA}}\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\SI{2}{\angstrom}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend ,
...
IN107019.
\DIFaddbegin \DIFadd{Based on observations collected at the European Southern Observatory
under ESO programme 60.A-9100(A).
}\DIFaddend Scientific software and databases used in this work include
...
\DIFaddbegin \DIFadd{I thank Bob O'Dell for detailed comments on an earlier draft of this paper
...
\DIFaddbegin \bibitem[\protect\citeauthoryear{{Arrieta} \& {Torres-Peimbert}}{{Arrieta} \&
  {Torres-Peimbert}}{2003}]{Arrieta:2003a}
{Arrieta} \DIFadd{A.,  }{\DIFadd{Torres-Peimbert}} \DIFadd{S.,  2003, }\mn@doi [\apjs] {10.1086/374922}\DIFadd{,
  }\href {https://ui.adsabs.harvard.edu/abs/2003ApJS..147...97A} {147, 97}

\DIFaddend \bibitem[\protect\citeauthoryear{{Bacon} et~al.,}{{Bacon}
...
\DIFaddbegin \bibitem[\protect\citeauthoryear{{Bernstein}, {Shroll}, {Galazutdinov}  \&
  {Beletsky}}{{Bernstein} et~al.}{2018}]{Bernstein:2018a}
{Bernstein} \DIFadd{L.~S.,  }{\DIFadd{Shroll}} \DIFadd{R.~M.,  }{\DIFadd{Galazutdinov}} \DIFadd{G.~A.,   }{\DIFadd{Beletsky}} \DIFadd{Y.,
  2018, }\mn@doi [\apj] {10.3847/1538-4357/aabd85}\DIFadd{, }\href
  {https://ui.adsabs.harvard.edu/abs/2018ApJ...859..174B} {859, 174}

\DIFaddend \bibitem[\protect\citeauthoryear{{Blagrave}, {Martin}, {Rubin}, {Dufour},
...
\DIFaddbegin \bibitem[\protect\citeauthoryear{{Doi}, {O'Dell}  \& {Hartigan}}{{Doi}
  et~al.}{2004}]{Doi:2004a}
{Doi} \DIFadd{T.,  }{\DIFadd{O'Dell}} \DIFadd{C.~R.,   }{\DIFadd{Hartigan}} \DIFadd{P.,  2004, }\mn@doi [\aj]
  {10.1086/386351}\DIFadd{, }\href {http://adsabs.harvard.edu/abs/2004AJ....127.3456D}
  {127, 3456}

\DIFaddend \bibitem[\protect\citeauthoryear{{Donati}, {Babel}, {Harries}, {Howarth},
...
{Hacar} \DIFadd{A.,  }{\DIFadd{Tafalla}} \DIFadd{M.,  }{\DIFadd{Forbrich}} \DIFadd{J.,  }{\DIFadd{Alves}} \DIFadd{J.,  }{\DIFadd{Meingast}} \DIFadd{S.,
  }{\DIFadd{Grossschedl}} \DIFadd{J.,   }{\DIFadd{Teixeira}} \DIFadd{P.~S.,  2018, }\mn@doi [\aap]
  {10.1051/0004-6361/201731894}\DIFadd{, }\href
...
\DIFaddbegin \bibitem[\protect\citeauthoryear{{Lai}, {Witt}  \& {Crawford}}{{Lai}
  et~al.}{2017}]{Lai:2017a}
{Lai} \DIFadd{T. S.~Y.,  }{\DIFadd{Witt}} \DIFadd{A.~N.,   }{\DIFadd{Crawford}} \DIFadd{K.,  2017, }\mn@doi [\mnras]
  {10.1093/mnras/stx1124}\DIFadd{, }\href
  {https://ui.adsabs.harvard.edu/abs/2017MNRAS.469.4933L} {469, 4933}

\DIFaddend \bibitem[\protect\citeauthoryear{{Lai}, {Witt}, {Alvarez}  \& {Cami}}{{Lai}
...
\DIFaddbegin \bibitem[\protect\citeauthoryear{{Lee}, {Jung}, {Song}  \& {Ahn}}{{Lee}
  et~al.}{2006}]{Lee:2006a}
{Lee} \DIFadd{H.-W.,  }{\DIFadd{Jung}} \DIFadd{Y.-C.,  }{\DIFadd{Song}} \DIFadd{I.-O.,   }{\DIFadd{Ahn}} \DIFadd{S.-H.,  2006, }\mn@doi [\apj]
  {10.1086/498143}\DIFadd{, }\href
  {https://ui.adsabs.harvard.edu/abs/2006ApJ...636.1045L} {636, 1045}

\DIFaddend \bibitem[\protect\citeauthoryear{{Luhman}, {Engelbracht}  \& {Luhman}}{{Luhman}
...
\DIFaddbegin \bibitem[\protect\citeauthoryear{{O'Dell}}{{O'Dell}}{2001}]{ODell:2001b}
{O'Dell} \DIFadd{C.~R.,  2001, }\mn@doi [\araa] {10.1146/annurev.astro.39.1.99}\DIFadd{, }\href
  {http://adsabs.harvard.edu/abs/2001ARA%DIF > 26A..39...99O} {39, 99}


\DIFaddend \bibitem[\protect\citeauthoryear{{O'Dell} \& {Yusef-Zadeh}}{{O'Dell} \&
...
\DIFdelbegin %DIFDELCMD < \bibitem[\protect\citeauthoryear{{O'Dell}, {Wen}  \& {Hu}}{{O'Dell}
%DIFDELCMD <   et~al.}{1993}]{ODell:1993a}
%DIFDELCMD < {O'Dell} %%%
\DIFdelend \DIFaddbegin \bibitem[\protect\citeauthoryear{{O'Dell}, {Valk}, {Wen}  \& {Meyer}}{{O'Dell}
  et~al.}{1993a}]{ODell:1993b}
{O'Dell} \DIFaddend C.~R.,  {\DIFaddbegin \DIFadd{Valk}} \DIFadd{J.~H.,  }{\DIFaddend Wen} Z.,   {\DIFaddbegin \DIFadd{Meyer}} \DIFadd{D.~M.,  1993a, }\mn@doi
  [\apj] {10.1086/172238}\DIFadd{, }\href
...
{O'Dell} \DIFadd{C.~R.,  }{\DIFadd{Wen}} \DIFadd{Z.,   }{\DIFaddend Hu} X.,  \DIFdelbegin \DIFdel{1993}\DIFdelend \DIFaddbegin \DIFadd{1993b}\DIFaddend , \mn@doi [\apj] {10.1086/172786},
  \href {http://adsabs.harvard.edu/abs/1993ApJ...410..696O} {410, 696}

\DIFaddbegin \bibitem[\protect\citeauthoryear{{O'Dell}, {Hartigan}, {Lane}, {Wong},
  {Burton}, {Raymond}  \& {Axon}}{{O'Dell} et~al.}{1997}]{ODell:1997a}
{O'Dell} \DIFadd{C.~R.,  }{\DIFadd{Hartigan}} \DIFadd{P.,  }{\DIFadd{Lane}} \DIFadd{W.~M.,  }{\DIFadd{Wong}} \DIFadd{S.~K.,  }{\DIFadd{Burton}} \DIFadd{M.~G.,
  }{\DIFadd{Raymond}} \DIFadd{J.,   }{\DIFadd{Axon}} \DIFadd{D.~J.,  1997, }\mn@doi [\aj] {10.1086/118507}\DIFadd{, }\href
  {http://adsabs.harvard.edu/abs/1997AJ....114..730O} {114, 730}

\DIFaddend \bibitem[\protect\citeauthoryear{{O'Dell}, {Ferland}  \& {Peimbert}}{{O'Dell}
...
\DIFaddbegin \bibitem[\protect\citeauthoryear{{Pequignot}, {Baluteau}, {Morisset}  \&
  {Boisson}}{{Pequignot} et~al.}{1997}]{Pequignot:1997a}
{Pequignot} \DIFadd{D.,  }{\DIFadd{Baluteau}} \DIFadd{J.~P.,  }{\DIFadd{Morisset}} \DIFadd{C.,   }{\DIFadd{Boisson}} \DIFadd{C.,  1997, }\aap\DIFadd{,
...
{Perrin} \DIFadd{J.~M.,  }{\DIFadd{Sivan}} \DIFadd{J.~P.,  1992, }\aap\DIFadd{, }\href
  {https://ui.adsabs.harvard.edu/abs/1992A&A...255..271P} {255, 271}

\DIFaddend \bibitem[\protect\citeauthoryear{{Salgado} et~al.,}{{Salgado}
...
\DIFaddbegin \bibitem[\protect\citeauthoryear{{Schmidt}, {Cohen}  \& {Margon}}{{Schmidt}
  et~al.}{1980}]{Schmidt:1980a}
{Schmidt} \DIFadd{G.~D.,  }{\DIFadd{Cohen}} \DIFadd{M.,   }{\DIFadd{Margon}} \DIFadd{B.,  1980, }\mn@doi [\apjl]
  {10.1086/183309}\DIFadd{, }\href
  {https://ui.adsabs.harvard.edu/abs/1980ApJ...239L.133S} {239, L133}

\DIFaddend \bibitem[\protect\citeauthoryear{Shenstone}{Shenstone}{1970}]{Shenstone:1970a}
...
\DIFaddbegin \bibitem[\protect\citeauthoryear{{Weingartner} \& {Draine}}{{Weingartner} \&
  {Draine}}{2001}]{Weingartner:2001a}
{Weingartner} \DIFadd{J.~C.,  }{\DIFadd{Draine}} \DIFadd{B.~T.,  2001, }\mn@doi [\apj] {10.1086/318651}\DIFadd{,
  }\href {http://adsabs.harvard.edu/abs/2001ApJ...548..296W} {548, 296}

\DIFaddend \bibitem[\protect\citeauthoryear{{Whiteoak}}{{Whiteoak}}{1966}]{Whiteoak:1966a}
...
\bibitem[\protect\citeauthoryear{{Witt} \& {Lai}}{{Witt} \&
  {Lai}}{2020}]{Witt:2020a}
{Witt} \DIFadd{A.~N.,  }{\DIFadd{Lai}} \DIFadd{T. S.~Y.,  2020, }\mn@doi [\apss]
  {10.1007/s10509-020-03766-w}\DIFadd{, }\href
